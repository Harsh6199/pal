...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            boolean isLogout = intent.getExtras().getBoolean("logout");
            if (isLogout) {
                Toast.makeText(this, "logging your out", Toast.LENGTH_SHORT).show();
                mAuth.signOut();
...
//                finish();
    ...
    private void updateUI(boolean isNewUser) {
        if (isNewUser) {
            Log.d("current user", "name: " + mAuth.getCurrentUser().getDisplayName() + "photo: " + mAuth.getCurrentUser().getPhotoUrl().toString());
